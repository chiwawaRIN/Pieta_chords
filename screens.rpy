...
init offset = -1
define config.layers = [ 'ab', 'master', 'transient', 'screens', 'overlay']
...
screen navigation():
 if renpy.get_screen("main_menu"):
        ...
        vbox:##hbox로!
            ...
            yalign 0.5
            xoffset 10 #2022.11.16일 변경 #2022.12.03 드디어 적용
...
screen main_menu():
    ...
    ##if gui.show_name:
        ...
        ##vbox:
            ...
            ##text "[config.version]":
                ##style "main_menu_version" 얘네 다 필요없어요
...
style main_menu_frame:
    ...
    ##background "gui/overlay/main_menu.png" 오버레이 삭제!
...
style game_menu_outer_frame:
    ...
    background "gui/overlay/overlay.png"
